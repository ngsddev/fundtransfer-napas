...
public class VerifyResponseModel {
    ...
    public VerifyResponseModel(String error_code, String error_message, String transact_ref, String customer_id, String debit_bank_id, String debit_acc_id, int debit_balance, String credit_bank_id, String credit_acc_id, int transact_amount, String currency, String transact_message, String signature) {
